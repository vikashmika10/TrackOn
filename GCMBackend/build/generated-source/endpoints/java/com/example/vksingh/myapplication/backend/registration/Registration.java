 ...
 * on 2015-03-12 at 12:47:56 UTC 
 * Modify at your own risk.
 */

package com.example.vksingh.myapplication.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<com.example.vksingh.myapplication.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.example.vksingh.myapplication.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String phNumber) throws java.io.IOException {
    Register result = new Register(regId, phNumber);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{phNumber}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String phNumber) {
      ...
      this.phNumber = com.google.api.client.util.Preconditions.checkNotNull(phNumber, "Required parameter phNumber must be specified.");
    }
    ...
    public Register setPhNumber(java.lang.String phNumber) {
